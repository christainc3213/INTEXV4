...
function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const registerResponse = await fetch("https://intexv4-backend-a9gufubwgrdmgtcs.eastus-01.azurewebsites.net/register", {
        method: "POST",
        headers: {
      ...
      const loginUrl = "https://intexv4-backend-a9gufubwgrdmgtcs.eastus-01.azurewebsites.net/login?useCookies=true";
