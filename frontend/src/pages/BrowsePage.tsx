...
const BrowsePage = () => {
    ...
    useEffect(() => {
        const fetchRecommendations = async () => {
            try {
                const userId = 11;
                const response = await fetch(`https://intexv4-backend-a9gufubwgrdmgtcs.eastus-01.azurewebsites.net/api/BrowseRecommendations/${userId}`);
        ...
        const fetchGenreRecs = async (genre: string, setter: (movies: MovieType[]) => void) => {
            try {
                const userId = 11;
                const res = await fetch(`https://intexv4-backend-a9gufubwgrdmgtcs.eastus-01.azurewebsites.net/api/BrowseRecommendations/genre/${genre}/${userId}`);
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch("https://intexv4-backend-a9gufubwgrdmgtcs.eastus-01.azurewebsites.net/movietitles");
